...
package com.example.root.leshanclient.demo;
...
//            else
                serverURI = "coap://172.21.73.144:" + LwM2m.DEFAULT_COAP_PORT;
//        }
...
//            }
//        }
        System.out.print(endpoint+"/"+localAddress+"/"+false+"/"+serverURI+"/"+pskIdentity);
